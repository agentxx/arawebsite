...
<div class="user-panel">
	...
	{if is_user_logged_in()}
		...
		<div class="user-actions">
			...
			{if user_can( $currentUser, 'ait_toolkit_items_publish_items' )}
			...
			<a href="{admin_url($adminItemsUrl)}" title="{__ 'Items'}" class="user-items">{__ 'My Initiative'}<span>{$itemsCount}</span></a>
			{/if}
			
			{if defined('AIT_EVENTS_PRO_ENABLED') && user_can( $currentUser, 'ait_toolkit_eventspro_publish_events' )}
			...
			<a href="{admin_url($adminEventsUrl)}" title="{__ 'Events'}" class="user-events">{__ 'Opportunities & Events'}<span>{$eventsCount}</span></a>
			{/if}
		</div>
