...
<div class="filters-wrap">
	{if $postType == "ait-event-pro"}
		...
		<h2>{!_x '%1$s Opportunities', 'event pro taxonomy'|printf: $maxLabel}</h2>
	{else}
	...
	<div class="filters-container filters-container-op ait-toggle-area">
		<div class="content">
			{if $postType != 'ait-event-pro'}
			<div class="filter-container filter-container-op filter-count" data-filterid="count">
				<div class="content">
			...
			{/if}
			<div class="filter-container filter-container-op filter-orderby filter-orderby-op" data-filterid="orderby">
				<div class="content">
			...
			<div class="filter-container filter-container-op filter-order filter-order-op" data-filterid="order">
				<div class="content">
			...
			jQuery(document).ready(function(){
				jQuery('.filters-container-op .filter-container-op').each(function(){
