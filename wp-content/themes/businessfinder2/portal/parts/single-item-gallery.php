	...
	<div class="gallery-slider">
		...
		<ul class="slider-items">
			...
			<li {if $iterator->first}class="active"{/if}>
				...
				<a href="{$item['image']}" title="{$title}" target="_blank" data-rel="item-gallery" data-focus="disabled">
					<div style="background-image: url('{imageUrl $item['image'], width => 1200, height => 400, crop => 1}')"></div>
				</a>
			</li>
			{/foreach}
		</ul>
